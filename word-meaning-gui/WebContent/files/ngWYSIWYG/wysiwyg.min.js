! function(e, t) {
    ...
    "use strict";
    e.module("ngWYSIWYG", ["ngSanitize"]), e.module("ngWYSIWYG")
        ...
        .directive("ngpColorsGrid", ["NGP_EVENTS", function(e) {
            var t = function(t, n) {
                t.$on(e.CLICK_AWAY, function() {
                    ...
                    .bind("click", function(e) {
                        ...
                        for (var t = 0; t < document.getElementsByClassName("ngp-colors-grid")
                            .length; t += 1) e(document.getElementsByClassName("ngp-colors-grid")[t])
                    })
            };
            return {
                link: t,
        ...
        .directive("ngpSymbolsGrid", ["NGP_EVENTS", function(e) {
            var t = function(t, n) {
                t.$on(e.CLICK_AWAY, function() {
                        t.$apply(function() {
                            t.show = !1
                    ...
                    .bind("click", function(e) {
                        ...
                        for (var t = 0; t < document.getElementsByClassName("ngp-symbols-grid")
                            .length; t += 1) e(document.getElementsByClassName("ngp-symbols-grid")[t])
                    })
            };
            return {
                link: t,
        ...
        .service("ngpImageResizer", ["NGP_EVENTS", function(e) {
            function t(e) {
                e.preventDefault()
            }
            ...
            function l() {
                ...
                p.style.height = e.getPropertyValue("height"), p.style.width = e.getPropertyValue("width"), p.style.top = v.getBoundingClientRect()
                    .top + d.pageYOffset + "px", p.style.left = v.getBoundingClientRect()
                    .left + d.pageXOffset + "px", p.style.display = "block"
            }
    ...
    return e.module("ngWYSIWYG")
        .directive("wysiwygEdit", ["ngpUtils", "NGP_EVENTS", "$rootScope", "$compile", "$timeout", "$q", function(n, o, i, r, a, l) {
            var s = function(a, s, c, d) {
                function u() {
                    null == m && (m = document.querySelector("wysiwyg-edit")
                        .querySelector("iframe"), y = m.contentDocument, f = y.defaultView)
                }
                ...
                b = b.replace("{contentStyle}", c.contentStyle || ""), s.html(b), r(s.contents())(a), a.execCommand = function(e, t) {
                    ...
                    if (u(), null != f.getSelection()
                        .focusNode) {
                        var t = n.getSelectionBoundaryElement(f, !0),
                            o = "http://";
                        if (t && "A" == t.nodeName) {
                            o = t.href;
                            var i = y.createRange();
                        ...
                        var s;
                        s = a.api && a.api.insertLink && e.isFunction(a.api.insertLink) ? a.api.insertLink.apply(a.api.scope || null, [o]) : prompt("Please enter the URL", "http://"), l.when(s)
                            .then(function(e) {
                    ...
                    var t;
                    a.api && a.api.insertImage && e.isFunction(a.api.insertImage) ? t = a.api.insertImage.apply(a.api.scope || null) : (t = prompt("Please enter the picture URL", "http://"), t = '<img src="' + t + '">'), l.when(t)
                        .then(function(e) {
                            p(e)
                        })
                }, s.ready(function() {
                    ...
                    for (var t = 0; t < document.getElementsByClassName("tinyeditor-header")
                        .length; t += 1) e(document.getElementsByClassName("tinyeditor-header")[t])
        ...
        .directive("ngpContentFrame", ["ngpImageResizer", "ngpUtils", "NGP_EVENTS", "$compile", "$timeout", "$sanitize", function(t, n, o, i, r, a) {
            var l = function(i, l, s, c) {
                ...
                var u = e.element(l[0].contentDocument.body),
                    p = e.element(l[0].contentDocument.head);
                u.attr("contenteditable", "true"), d.addEventListener("click", function(e) {
                    "HTML" === e.target.tagName && e.target.querySelector("body")
                        .focus(), i.$emit(o.ELEMENT_CLICKED, e.target)
                ...
                u.bind("click keyup change paste", function() {
                    g && r.cancel(g), g = r(function() {
                        var e = u[0].ownerDocument,
                            t = e.querySelector(".ngp-image-resizer"),
                            o = u[0].innerHTML;
                        t && (o = o.replace(t.outerHTML, "")), c.$setViewValue(o);
                        var r = n.getSelectionBoundaryElement(l[0].contentWindow, !0);
                        if (r) {
                            var a = l[0].contentWindow.getComputedStyle(r),
                                s = {
                    ...
                    } else d.selection && "Control" != d.selection.type && d.selection.createRange()
                        .pasteHTML(t);
                    i.sync()
        ...
        .directive("ngpResizable", ["$document", function(e) {
            return function(t, n) {
                var o = e[0],
                    i = n[0],
                ...
                r.className = "resizer", i.appendChild(r), r.addEventListener("mousedown", function() {
                    function e(e) {
                        e.preventDefault();
                        var t = e.pageY;
                        e.view != o.defaultView && (t = e.pageY + e.view.frameElement.getBoundingClientRect()
                            .top + o.defaultView.pageYOffset);
                        var n = t - (i.getBoundingClientRect()
                                .top + o.defaultView.pageYOffset),
                            r = i.style.height.replace("px", "");
